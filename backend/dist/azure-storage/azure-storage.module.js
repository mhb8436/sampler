...
let AzureStorageModule = class AzureStorageModule {
};
exports.AzureStorageModule = AzureStorageModule;
exports.AzureStorageModule = AzureStorageModule = __decorate([
    (0, common_1.Global)(),
    (0, common_1.Module)({
        imports: [config_1.ConfigModule],
        providers: [azure_storage_service_1.AzureStorageService],
